...
module.exports.validateCTSDoanhNghiep = () => {
    return [ 
      ...
      check('MST', 'Vui lòng nhập đúng định dạng Mã số thuế').not().isLength({max:10,min:10}),
      ...
      check('emailGD', 'Vui lòng nhập đúng định dạng Email').not().isEmail(),
      check('hoTenChuDoanhNghiep', 'Họ tên chủ doanh nghiệp không được trống').not().isEmpty(),
      check('emailChuDoanhNghiep', 'Họ tên chủ doanh nghiẹp không được trống').not().isEmpty(),
