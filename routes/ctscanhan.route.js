...
var upload = multer({ dest: './public/uploads/personal' })



router.get('/digital-certificate/personal',middlewares.checkAuthencation, controllerCTSCaNhan.personal);
router.post('/digital-certificate/personal/add',upload.single('fileHoSo'), middlewares.checkAuthencation, validateCTSCaNhan(), controllerCTSCaNhan.add);
